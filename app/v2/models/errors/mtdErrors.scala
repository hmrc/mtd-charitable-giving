...
object GiftAidSpecifiedYearPreviousFormatError
    extends Error("FORMAT_GIFT_AID_SPECIFIED_YEAR_PREVIOUS_YEAR", "The specified year treated as previous year amount is invalid")

object GiftAidFollowingYearSpecifiedFormatError
    extends Error("FORMAT_GIFT_AID_FOLLOWING_YEAR_SPECIFIED_YEAR", "The following year treated as specified year amount is invalid")

object GiftsNonUKInvestmentsNamesFormatError
    extends Error("FORMAT_GIFTS_NONUK_INVESTMENTS_NAMES", "The non-UK investments charity names list is invalid")

//Rule Errors
object EmptyOrNonMatchingBodyRuleError extends Error("RULE_INCORRECT_OR_EMPTY_BODY_SUBMITTED", "An empty or non-matching body was submitted")
object GiftAidAndGiftsEmptyRuleError   extends Error("RULE_EMPTY_GIFTS_OR_GIFT_AID", "A supplied gift aid or gifts object must not be empty")

object NonUKNamesNotSpecifiedRuleError
    extends Error("RULE_GIFT_AID_NONUK_AMOUNT_WITHOUT_NAMES", "Non-UK charity gift aid amount supplied without the non-UK gift aid charity names")

object NonUKAmountNotSpecifiedRuleError
    extends Error("RULE_GIFT_AID_NONUK_NAMES_WITHOUT_AMOUNT",
                  "Non-UK charity gift aid charity names supplied without an amount or the amount was zero")

object NonUKInvestmentsNamesNotSpecifiedRuleError
    extends Error(
      "RULE_GIFTS_NONUK_INVESTMENTS_AMOUNT_WITHOUT_NAMES",
      "Positive non-UK gift of investment amount supplied without non-UK gift of investment charity names"
    )

object NonUKInvestmentAmountNotSpecifiedRuleError
    extends Error("RULE_GIFTS_NONUK_INVESTMENTS_NAMES_WITHOUT_AMOUNT",
                  "Non-UK gift of investment charity names supplied without an amount or the amount was zero")

object TaxYearNotSpecifiedRuleError
